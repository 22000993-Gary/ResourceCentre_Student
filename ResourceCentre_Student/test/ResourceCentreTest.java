...
public class ResourceCentreTest {
	...
	public void testRetrieveAllChromebook() {
		...
		//Test Case 1
		 ...
		 testOutput += String.format("%-10s %-30s %-10s %-10s %-20s\n", "CB0012", "SAMSUNG Chromebook 4+", "Yes", "", "Win10");
		 ...
		 assertNotEquals("Test that Chromebook arraylist size is not 3.", 3, chromebookList.size());
		 assertTrue("Test that the unavailable item CB0013 is not displayed.", allChromebook.contains("CB0013") == false);
		}
